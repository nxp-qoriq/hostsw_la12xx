...
int main(int argc, char *argv[])
{
	...
	sprintf(dev_name, "/dev/%s%d", GUL_DEV_NAME_PREFIX, mod_id);
	...
	if (argc  > 4) {
		...
		offset = mi->scratchregions[GUL_SCRATCH_MODEM_SHARE].host_phy_addr;
		size = mi->scratchregions[GUL_SCRATCH_MODEM_SHARE].size;
	}
